var Screen = {
    ...
    xxxShow: function() {
        Screen.showAppInPageTwo('.xxx-area')
        Screen.showPageTwo()
    },
    yyyShow: function() {
        Screen.showAppInPageTwo('.yyy-area')
        Screen.showPageTwo()
    },
    ...
    xxx: function() {
        var xxxButton = e('.xxx')
        bindEvent(xxxButton, 'click', function() {
            Screen.xxxShow()
        })
    },
    yyy: function() {
        var yyyButton = e('.yyy')
        bindEvent(yyyButton, 'click', function() {
            Screen.yyyShow()
        })
    },
...
var Weather = {
    ...
    loadWeatherSuggestion: function(parsedData) {
        ...
        var html = `
            ...
            <div id="id-1" class="weather-suggestion-content contentShow"><div>${air}</div><div>${airLong}</div></div>
            <div id="id-2" class="weather-suggestion-content"><div>${comf}</div><div>${comfLong}</div></div>
            <div id="id-3" class="weather-suggestion-content"><div>${cw}</div><div>${cwLong}</div></div>
            <div id="id-4" class="weather-suggestion-content"><div>${drsg}</div><div>${drsgLong}</div></div>
            <div id="id-5" class="weather-suggestion-content"><div>${flu}</div><div>${fluLong}</div></div>
            <div id="id-6" class="weather-suggestion-content"><div>${sport}</div><div>${sportLong}</div></div>
            <div id="id-7" class="weather-suggestion-content"><div>${trav}</div><div>${travLong}</div></div>
            <div id="id-8" class="weather-suggestion-content"><div>${uv}</div><div>${uvLong}</div></div>
        `
